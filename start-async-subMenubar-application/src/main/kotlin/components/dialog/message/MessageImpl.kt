...
class MessageImpl internal constructor(private val frame : Frame, val pair : Pair<String,String>, val option : EnumDialog, val icon : ImageIcon?) : Message {
    ...
    companion object {
        fun create(frame: Frame, pair: Pair<String, String>, option: EnumDialog): Message {
            return MessageImpl(frame, pair, option, null)
        }

        fun create(frame: Frame, pair: Pair<String, String>, option: EnumDialog, icon: ImageIcon): Message {
