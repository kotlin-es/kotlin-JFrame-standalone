...
object Main {
    ...
    @JvmStatic fun main(args: Array<String>) {
        SwingUtilities.invokeLater {
            ...
            val sliderCenter = SliderImpl.create(Slider.POSITION,Slider.MIN, Slider.MAX,Slider.VALUE)
            val panelCenter = PanelImpl.create(FlowLayout(),Pair(sliderCenter,textAreaCenter))
