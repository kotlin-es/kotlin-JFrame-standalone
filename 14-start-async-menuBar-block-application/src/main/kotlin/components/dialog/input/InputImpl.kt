...
class InputImpl internal constructor(private val frame : Frame, private val pair : Pair<String,String>, private val option : EnumDialog, private val icon : Icon?, private val selectionValues: ArrayList<Object>?, private val initialSelectionValue : Object?) : Input {
    ...
    companion object {
        ...
        fun create(frame: Frame, pair: Pair<String, String>, option: EnumDialog): Input {
            return InputImpl(frame, pair, option, null, null, null)
        }

        fun create(frame: Frame, pair: Pair<String, String>, option: EnumDialog, icon: Icon?, selectionValues: ArrayList<Object>?, initialSelectionValue: Object?): Input {
            return InputImpl(frame, pair, option, icon, selectionValues, initialSelectionValue)
        }
    }
