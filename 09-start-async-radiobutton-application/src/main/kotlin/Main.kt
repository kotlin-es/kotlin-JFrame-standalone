...
import components.menuBar.child.MenuBarFile_
...
object Main {
    ...
    @JvmStatic fun main(args: Array<String>) {
        SwingUtilities.invokeLater {
            ...
            val menuFile = menuBar.createMenu(MenuBarImpl.MenuBarFile_())
            val menuFileSubMenu = Arrays.asList<JComponent>(
            ...
            val menuFileGroup = GroupImpl(menuFileSubMenu)

            menuBar
                .createSubMenu(menuFile,menuFileSubMenu)
                .addSeparator(menuFile)


            val menuDialog = menuBar.createMenu(MenuBarImpl.MenuBarDialog())
            val menuDialogSubMenu = Arrays.asList<JComponent>(
            ...
            val menuList = Arrays.asList<JComponent>(
                    menuFile,
                    menuDialog,
                    menuBar.createMenu(MenuBarImpl.MenuBarChooser(frame))
            )
