...
class MenuItemImpl internal constructor(private val _name: String, private val shortCut : Int, private val action : (ActionEvent) -> Unit ) : JMenuItem(_name) , MenuItem {
    ...
    companion object {
        fun create(name: String, shortCut : Int ,action :(ActionEvent) -> Unit) : MenuItem {
            return MenuItemImpl(name, shortCut, action)
        }

        fun create(name: String ,action :(ActionEvent) -> Unit) : MenuItem {
            return MenuItemImpl(name, MenuItem.NONE, action)
        }

        fun create(name: String ) : MenuItem {
            return MenuItemImpl(name, MenuItem.NONE, {})
        }
    }
